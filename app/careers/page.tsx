...
//     }, 3000); // Show the first animation for 3 seconds
...
//           ref={heroRef}
//           style={{ backdropFilter: "blur(10px)" }} // Apply a slight blur to the background
//         >
//           <Careers />
...
//               <h1 className="text-5xl font-bold mb-6">Careers — Join us!</h1>
//               <p className="mb-4">
//                 Vivanti prioritises diversity, equality, and inclusion (DEI) and actively promotes
//                 these values as specialists in healthcare marketing. We recognise and appreciate the
//                 diverse backgrounds, perspectives, experiences, and identities of our employees,
//                 clients, and stakeholders.
//               </p>
//               <p className="mb-4">
//                 As a healthcare marketing agency our internal policies aim to foster an inclusive
//                 work culture where everyone feels respected, valued, and empowered to contribute.
//                 Research shows that diverse teams are more innovative, creative, and better equipped
//                 to solve complex problems, and our international team exemplifies this.
//               </p>
//               <p className="font-semibold">
//                 Join our friendly team, where collaboration and positivity thrive.
//               </p>
