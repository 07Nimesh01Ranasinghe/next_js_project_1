...
// Extend JSX Intrinsic Elements for ThreeGlobe
declare module "@react-three/fiber" {
  interface ThreeElements {
    threeGlobe: Object3DNode<ThreeGlobe, typeof ThreeGlobe>;
  }
...
export function Globe({ globeConfig, data }: WorldProps) {
  ...
  const buildMaterial = () => {
    ...
    // Explicitly cast globeMaterial as MeshStandardMaterial
    ...
    if (globeMaterial) {
      ...
      globeMaterial.emissiveIntensity = globeConfig.emissiveIntensity || 0.1;
      globeMaterial.metalness = 0.4; // Added for specular highlights
      globeMaterial.roughness = 0.6; // Added for shiny surfaces
    }
  };
