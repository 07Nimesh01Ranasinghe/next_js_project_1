      ...
      <div className="flex flex-col md:flex-row items-center justify-between mb-10">
        ...
        <div className="w-full md:w-1/3">
          ...
          <div className="space-y-4">
            <div className="flex items-center space-x-3 p-4 rounded-lg border border-gray-300 bg-gradient-to-r from-purple-500 to-purple">
                <span className=" text-black">phone</span>
                <p className="text-lg text-blcak">+0123456789</p>
            </div>
            <div className="flex items-center space-x-3 p-4 rounded-lg border border-gray-300 bg-gradient-to-r from-purple-500 to-purple">
                <span className=" text-black">email</span>
                <p className="text-lg text-black">example@email.com</p>
            </div>
            <div className="flex items-center space-x-3 p-4 rounded-lg border border-gray-300 bg-gradient-to-r from-purple-500 to-purple">
                <span className=" text-black">location_on</span>
                <p className="text-lg text-black">775 Rolling Green Rd.</p>
            </div>
