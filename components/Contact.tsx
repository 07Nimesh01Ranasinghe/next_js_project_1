  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      const result = await emailjs.send(
        "service_9yseswt", // Replace with your EmailJS service ID
        "template_woc39fh", // Replace with your EmailJS template ID
        {
        ...
        "kv2D0agjCdgahEhQg" // Replace with your EmailJS public key
      );
