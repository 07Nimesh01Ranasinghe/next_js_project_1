  ...
  return (
    <section className="w-full py-10">
      ...
      <div className="grid grid-cols-2 md:grid-cols-4 gap-2 items-center justify-center px-4 mt-12">
        ...
        <Card
          title="Mobile App Development"
          icon={<FaMobileAlt className="text-7xl text-white" />}
        ...
        <Card
          title="Web Application Development"
          icon={<FaGlobe className="text-7xl text-white" />}
        ...
        <Card
          title="Desktop Applications"
          icon={<FaDesktop className="text-7xl text-white" />}
        ...
        <Card
          title="Business Intelligence"
          icon={<FaChartLine className="text-7xl text-white" />}
        ...
        <Card
          title="UI/UX"
          icon={<FaPencilRuler className="text-7xl text-white" />}
        ...
        <Card
          title="Robotics, ML, and IoT"
          icon={<FaRobot className="text-7xl text-white" />}
        ...
        <Card
          title="Digital Marketing"
          icon={<FaBullhorn className="text-7xl text-white" />}
        ...
        <Card
          title="Graphic & Design"
          icon={<FaPalette className="text-7xl text-white" />}
